(function () {
  ...
  async function generate(demo = false) {
    ...
    try {
      ...
      lastBrief = brief;
      lastLangs = languages;
      renderDirections(data.directions || [], demo ? "Demo mode" : data.cached ? "AI · cached" : "AI generated");
      el("generationStatus").innerHTML = `<span class="status-pip"></span>${demo ? "Demo mode · no Groq call" : data.cached ? "AI result · served from cache" : "AI result · generated by Groq"}`;
    } catch (err) {
